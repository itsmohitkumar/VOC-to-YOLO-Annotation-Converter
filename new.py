...
# Assuming these functions exist for database operations
# from your_db_module import get_user_by_username, get_user_campaigns, get_agentic_campaign_planner, update_agentic_campaign_planner
...
async def submit_feedback(
    ...
    try:
        ...
        # Try to get from approved_plan first, then fallback to plan or versioned plans
        ...
        for mk, dv in meta_defaults.items():
            ...
            if val is None:  # Changed from "not val" to handle empty strings/lists
